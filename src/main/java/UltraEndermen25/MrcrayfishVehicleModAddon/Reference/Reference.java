package UltraEndermen25.MrcrayfishVehicleModAddon.Reference;

public class Reference {
    public static final String MOD_ID = "vehicle_Addon";
    public static final String MOD_NAME = "Vehicle Mod Addon";
